...
func Generate(templator *templator.CITemplator, config *config.Commit0Config, basePath string) error {
	...
	util.TemplateFileIfDoesNotExist(ciConfigPath, ciFilename, templator.TravisCI, config)
